---
title: "Gossip, reputation, domain-specificity, and resource transfers among Aka hunter-gatherers, Ngandu horticulturalists, and MTurkers"
author: 
...
Information on the degree to which individuals in one's community excel or fall short on each of these reputational domains can be obtained via direct observation, or from other individuals in the community, i.e., gossip. Several theories have been put forward for the evolution of gossip, including ‘cultural learning’; ‘social learning,’ such as learning norms or one’s place in a group or acquiring new and important knowledge; strategy learning; social comparison; a mechanism for showing off one’s social skill and connections, and therefore one’s mate value; norm learning and enforcement; sanctioning, social control, or ‘policing’; a means to maintain the good reputations of allies; a means to maintain the unity, morals, and values of social groups; and as a means to facilitate social bonding and social cohesion in the very large groups that characterize humans [@hess2019, and references therein]. 

The key role of gossip and reputation in the evolution of human cooperation, especially via indirect reciprocity, is starting to receive considerable attention [@wu2016; @balliet2020]. Gossip has been demonstrated to increase cooperation via indirect reciprocity in experimental economics games [e.g., @sommerfeld2007] where reputational information impacts contributions to a shared pool of resources [e.g., @beersma2011], or where information about the past behaviors of cooperative partners impacts participants’ inclinations to engage in future cooperation [e.g., @feinberg2014]. Conversely, cooperators in public goods games transmit more honest gossip [@giardini2021]. Gossip was found to be more effective and efficient than punishment in promoting and maintaining cooperation in a public goods game [@wu2016a], and gossip also increases cooperation in the dictator and ultimatum games [@wu2019]. In addition, agent based simulations have explored how varying the quantity and quality of gossip impacts cooperation [@giardini2014; @giardini2016].

## Gossip and within-group competition for resources

When reputation mediates access to group resources, competition for those resources by group members will often take the form of gossip that aims to increase one's reputation relative to that of competitors. A considerable body of evidence from industrialized populations demonstrates that gossiping is a key strategy in indirect aggression, the suite of behaviors that are used to harm others but that do not involve hitting or other types of physical force [for reviews, see @archer2005; @hess2019]. Ethnographic studies of gossip find that it is often used in reputation management, i.e., maintaining and improving one's reputation relative to others [@hess2017]. In an observational study among Aka, a Congo Basin hunter-gatherer population, peer-rated gossiping was strongly positively correlated with peer-rated anger for both women and men, confirming that Aka perceive gossip as aggressive [@hess2010]. In an observational study of women in a Micronesian population, mating competition was associated with indirect aggression [@stone2015], and in an experimental vignette study with an MTurk sample, competition for a limited resource increased gossip, especially negative gossip [@hess2021].

@hess2019 proposed that in competition over resources within interdependent groups, negative gossip is more effective than physical aggression because one can reduce resource transfers to a competitor by harming his or her reputation, thereby increasing resource availability for oneself, without impairing the competitor's physical ability to continue contributing to the group. By the same token, positive gossip could increase transfers to a relative or ally by increasing his or her reputation. Because individuals' reputations can differ in different social domains [@garfield2021], reputation-based decisions to gossip about others, or to provide benefits, should be sensitive to the domain in which competition or help is occurring. To influence resource transfers within families, for instance, one should relay gossip that is relevant to family members, and to influence resource transfers within communities, one should relay gossip that is relevant to community members. In an experimental study involving competition over limited resources in a family vs. work context, @hess2021 found, as predicted, that individuals transmitted more family gossip in a family context and more work gossip in a work context. 

The theoretical models of the role of gossip in the evolution of cooperation in ancestral human communities require that gossip cause changes in individuals' reputations that then cause changes in the likelihood of providing benefits to them, yet there is scant evidence from small-scale societies of such causal relationships. There is also no evidence that, when making a decision about the transfer of resources, gossip receivers weigh gossip according to its relevance to the social context. 
...
3. The relationship between gossip and impressions are domain-specific, e.g., work gossip will be weighted more heavily in work contexts, and family gossip more heavily in family contexts.
...
1. Are peer-ratings of behaviors in common domains of reputation, i.e., work effort (industriousness), sharing (prosociality), anger (violating cultural conformity), and the quality of (allo)parenting, associated with peer-rated impressions of camp members?
...
Our main dependent/outcome variable was how likely the participant was to allocate the valuable resource (a raise or a valuable painting) to a same-sex target in the vignette.  After reading the vignette and the positive and negative work and family gossip statements, participants were asked how likely they were to allocate the valuable resource to the target: “How likely would you be to give the [raise/painting] to [Dave/Elizabeth]?” on a 1-9 Likert scale. Our predicted mediating variable was *impression*: “What is your impression of Dave/Elizabeth?”. We also asked some exploratory questions regarding competition with the target, e.g., “How competitive do you feel with Dave/Elizabeth?”
...
We tested the domain specificity hypothesis in three ways. First, we tested if there was an interaction of work vs. family condition on the effects of work gossip vs. family gossip on impression, predicting evidence for positive interaction coefficients, $\beta_4>0$ and $\beta_5>0$:
...
Second and third, we compared the magnitudes of the gossip coefficients in linear regression models of *impression*, predicting larger coefficients for gossip that was congruent with the domain (e.g., work gossip in the work condition) than for gossip that was not congruent (e.g., family gossip in the work condition).
...
### Three tests of gossip domain specificity
...
We conjectured that positive or negative gossip might influence perceptions that the target was a threat or competitor to the participant, and that this might change the likelihood of providing a benefit to the target. Our measures of threat and competition were *afraid*, *get_your_job*, *competition*, *interference*, and *criticize*. We did not have clear predictions about the direction of any such effects (e.g., negative gossip might make the target seem more threatening, positive gossip might make the target seem to be a more formidable competitor, and either could have a positive or negative effect on providing the benefit). To simplify this exploratory analysis, we computed a *total_gossip* score as the sum of congruent and incongruent gossip, and then investigated these possibilities with a correlation matrix and principle components analysis (PCA) of all study variables, and an exploratory Gaussian graphical model [@borsboom2021].
...
We also investigated possible effects of sex and age. We found no significant main effects of sex, or interactions with congruent or incongruent gossip (results not reported). However, there was a significant interaction of age with incongruent gossip such that increasing age was associated with a decreasing effect of *incongruent gossip* on *impression.* See @fig-mturkage, and @tbl-mturk, model 5.
...
This study provided strong evidence that differences in levels of positive gossip cause differences in rated willingness to *give benefits*, largely mediated by their effects on *impression*. Moreover, there was fairly consistent evidence that the impact of gossip is domain specific, with family gossip having a larger impact in family contexts than work contexts, and work gossip having a larger impact in work contexts than family contexts. More generally, congruent gossip had bigger impact on *impression* than incongruent gossip. These results align with those of @hess2021, who found that increasing competition for resources increased (mostly negative) gossip transmission by participants in a domain specific manner, i.e., they transmitted more gossip that was relevant to the domain of competition. Among US and Indian participants, these relationships were not significantly moderated by nationality.
...
The Ngandu value a reputation for generosity, and resource transfers among paternal and maternal relatives is routine. Like similar ethnic groups around the world, witchcraft accusations play an important role in Ngandu life, generally revolve around jealousy over accumulations of material wealth, and are a constant source of gossip. In this regard, they might encourage generosity and serve as a leveling mechanism [@boyette2013]. The Ngandu regularly have Aka hunter-gatherers work in their gardens in exchange for food, money, and tobacco (see @sec-aka for more on the Aka).

Shortly before this study was conducted, diamonds and gold were discovered nearby, and jobs at the mines dramatically increased cash flowing into the village. A few months after this study, CAR plunged into a civil war that, at the time of this writing, is ongoing.
...
### Three tests of domain-specificity
...
The Ngandu results, like the MTurk results, showed that increasingly positive gossip caused an increase in reported likelihood of transferring resources to the target, an effect mediated by the effect of gossip on the *impression* of the target. The evidence for domain specificity was weaker, however, as there was no significant interaction between work and family condition of the effect of gossip on impression, perhaps because work and family domains are more intertwined in this population than in the MTurk sample. In support of domain specificity, however, the coefficient of congruent gossip was significantly larger than the coefficient of incongruent gossip, as also seen in the MTurk study.
...
#| label: fig-akabiplot
#| message: false
#| fig-cap: "PCA and GGM of Aka study variables. **A:** PCA variable loadings. **B:** PCA biplot. **C:** Gaussian Graphical Model (GGM). Edge weights are partial correlation coefficients. Females were code as 0 and males as 1, so negative coefficients for sex indicate a female bias, and positive coefficents a male bias."
#| fig-width: 11
